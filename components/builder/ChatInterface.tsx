...
import { vscDark as DarkCodeTheme } from 'react-syntax-highlighter/dist/esm/styles/prism';
          ...
          {messages.length === 0 ? (
            ...
            >
              ...
              <p className="text-sm text-muted-foreground max-w-sm">
                Describe your app idea and I'll help you build it. Be as detailed or as vague as you
                like!
              </p>
            </motion.div>
          ) : (
